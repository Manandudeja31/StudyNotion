...
const Home = () => {
  return (
    <div>
      {/*Section1*/}
      <div
        className="relative mx-auto flex z-[1] flex-col w-11/12 items-center
            text-white"
      >
        {/* <Link to={"/signup"}> */}
        <div
        ...
        <div className=" pr-5">
          <CodeBlocks
            ...
            heading={
              <div className=" text-4xl font-semibold pt-7 max-w-[250px] pb-1">
                Start
      ...
      <div className=" bg-pure-greys-5 text-richBlack-700">
        ...
        <div
          className="mx-auto w-11/12 max-w-content flex flex-col items-center justify-between
                gap-7"
        >
          <div className="flex w-full flex-row mb-10 mt-[95px] ml-36 mr-20 gap-12">
            <div className="text-4xl font-semibold w-[45%] max-w-xl">
