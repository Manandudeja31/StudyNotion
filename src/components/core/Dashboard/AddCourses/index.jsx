    ...
    return(
        <>
            <div className="relative text-black">
                ...
                <div className=" absolute top-5 left-[600px] basis-[336px] w-80 rounded border border-richBlack-700 bg-richBlack-800 p-6 text-lg font-semibold text-richBlack-5">
