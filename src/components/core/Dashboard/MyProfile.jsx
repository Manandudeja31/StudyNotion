...
function MyProfile() {
  ...
  return (
    <div className=" ml-20">
      ...
      {/* section 1 */}
      <div className="relative mx-auto mt-10 flex max-w-3xl flex-wrap items-center gap-6 rounded-lg border border-richBlack-700 bg-richBlack-800 p-6 ml-10">
        <img
      ...
      {/* section 2 */}
      <div className="relative mx-auto mt-10 max-w-3xl gap-6 space-y-4 rounded-lg border border-richBlack-700 bg-richBlack-800 p-6 ml-10">
      ...
      {/* section 3 */}
      <div className="relative mx-auto mt-10 max-w-3xl grid-cols-2 gap-6 ml-10 space-y-4 rounded-lg border border-richBlack-700 bg-richBlack-800 p-6 sm:grid">
