...
const ExploreMore  = () => {
    ...
    return(
        <div className=" mt-10 text-center -mb-32">
            ...
            <div className="flex flex-row rounded-full bg-richBlack-800 mb-10 px-1 py-1
             border-richBlack-100 w-[90%] md:w-[63%] mx-auto mt-10">
                {
            ...
            <div className=" flex md:flex-row gap-10 justify-between flex-col">
                {
